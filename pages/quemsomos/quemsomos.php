		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 mb-5">
					...
					<p>
						A Cuidar+ Diagnóstico é uma empresa dedicada a oferecer serviços especializados em saúde, com foco em diagnósticos precisos e consultas cardiológicas. A clínica atua com uma equipe altamente qualificada de profissionais médicos, comprometidos em fornecer atendimento de excelência, pautado em segurança, tecnologia de ponta e um cuidado personalizado para cada paciente.
					</p>

					<p>
						Com uma infraestrutura moderna, a Cuidar+ Diagnóstico oferece uma ampla gama de exames de diagnóstico que auxiliam na detecção precoce de doenças, permitindo um tratamento mais eficaz e eficiente. Entre os exames realizados estão o eletrocardiograma, ecocardiograma, teste de esforço, Holter, e exames laboratoriais, todos fundamentais para monitorar a saúde cardíaca e de outros sistemas do corpo.
					</p>
