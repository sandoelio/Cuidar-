		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-9 offset-lg-2 text-center mb-5">
					...
					<p>
						Seja bem-vindo a <strong>Cuidar+</strong>. Somos um time multidisciplinar de excelência técnica, pronto para garantir um melhor atendimento, com seguraça e acolhimento no tratamento de doeças cardiológicas.<br>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-12 text-center mb-4">
					...
					<p>
						Conheça os convênios da Cuidar+ e agende agora seu atendimento conosco
					</p>
				</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-12 text-center mt-3 mb-lg-4">
					<a href="" class="btn btn-2">MAIS NOTÍCIAS E DICAS</a>
				</div>
			...
			<div class="row">
				...
				<div class="col-lg-6 offset-lg-6 pt-lg-5 pl-lg-5">
					...
					<h2 class="topic text-white">
						Cuide da sua saúde e de quem você ama na Cuidar+
					</h2>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-12 text-center">
					...
					<h2 class="topic mb-4">Estamos bem localizados no centro de Salvador</h2>

					<p>
						Localizada no coração do bairro das Graças, a Cuidar+ tem rápido acesso e fácil locomoção.
					</p>
				</div> <!-- col-lg-12 -->

				<div class="col-lg-12 text-center mb-4">
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3889.1013932198466!2d-38.46460312416973!3d-12.901201358399115!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x71611002c6e5d33%3A0xfd0ccb518a1bd5fc!2sClinica%20Cuidar%20Mais!5e0!3m2!1spt-BR!2sbr!4v1733003199809!5m2!1spt-BR!2sbr" width="100%" height="315" style="border:0; display: block;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
				</div> <!-- col-lg-12 -->
				...
				<div class="col-lg-4">
					<div class="media">
						...
						<div class="media-body pl-3">
							...
							<p>
								<small>
									R. General, 4 - Graças,<br>
									Salvador - BA, 00000-000
								</small>
							</p>
						</div>
					</div>
