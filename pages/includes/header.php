...
<body class="anime-scroll" id="inicio">
  ...
  <header class="header">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-xl-2 pr-lg-0 col-10  py-3">
          <a href="./" class="logo" data-animate="top" data-delay="2">
            <img src="assets/img/cuidar.png" class="img-fluid" alt="Cuidar+">
          </a>
        </div>
    ...
    <nav id="menu" role="navigation" data-animate="top" data-delay="3">
      ...
      <ul>
        <li><a href="./" <?php if ($menuativo == 'index.php'): echo 'class="active"';
                          endif; ?>>Inicial</a></li>
        <li><a href="quem-somos" <?php if ($menuativo == 'quemsomos.php'): echo 'class="active"';
                                  endif; ?>>Quem Somos</a></li>
        <li><a href="exames" <?php if ($menuativo == 'exames.php'): echo 'class="active"';
                              endif; ?>>Exames</a></li>
        <li><a href="medicos" <?php if ($menuativo == 'medicos.php'): echo 'class="active"';
                              endif; ?>>Médicos</a></li>
        <li><a href="convenios" <?php if ($menuativo == 'convenios.php'): echo 'class="active"';
                                endif; ?>>Convênios</a></li>
        <li><a href="blog" <?php if ($menuativo == 'blog.php'): echo 'class="active"';
                            endif; ?>>Blog</a></li>
        <li><a href="fale-conosco" <?php if ($menuativo == 'contato.php'): echo 'class="active"';
                                    endif; ?>>Fale Conosco</a></li>
